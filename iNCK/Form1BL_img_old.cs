...
namespace iNCK
{
    public partial class Form1BL_img_old : Form
    {
        ...
        private void IA01_Leave(object sender, EventArgs e)
        {
            ...
            try
            {
                if (obj_op.Validate_Dictionary("0", "select * from tbldict ", " where tabname = 'Form1BL' and var_id = 'IA01'", IA01.Text) == true)
                {
                    IA01.Focus();
                }
        ...
        private void IA03_Leave(object sender, EventArgs e)
        {
            ...
            try
            {
                if (obj_op.Validate_Dictionary("0", "select * from tbldict ", " where tabname = 'Form1BL' and var_id = 'IA03'", IA03.Text) == true)
                {
                    IA03.Focus();
                }
        ...
        private void IA04_Leave(object sender, EventArgs e)
        {
            ...
            try
            {
                if (obj_op.Validate_Dictionary("0", "select * from tbldict ", " where tabname = 'Form1BL' and var_id = 'IA04'", IA04.Text) == true)
                {
                    IA04.Focus();
                }
        ...
        private void IB01_Leave(object sender, EventArgs e)
        {
            ...
            try
            {
                if (obj_op.Validate_Dictionary("0", "select * from tbldict ", " where tabname = 'Form1BL' and var_id = 'IB01'", IB01.Text) == true)
                {
                    IB01.Focus();
                }
        ...
        private void IB06_Leave(object sender, EventArgs e)
        {
            ...
            try
            {
                if (obj_op.Validate_Dictionary("0", "select * from tbldict ", " where tabname = 'Form1BL' and var_id = 'IB06'", IB06.Text) == true)
                {
                    IB06.Focus();
                }
                ...
                if (ds != null)
                {
                    if (ds.Tables.Count > 0)
                    {
                        if (ds.Tables[0].Rows.Count > 0)
                        {
                            ...
                            {
                                FORM_ID.Text = ds.Tables[0].Rows[0]["FORM_ID"].ToString();
                            }
        ...
        private void AddUpdatePage(string spName)
        {
            ...
            try
            {
                ...
                string qry = "INSERT INTO formbl (formid, IA01, IA02, IA03, IA04, IA05, IB01, IB02, IB03, IB04, IB05, IB06, IB07, IB08, IB0901, IB0902, IB0903, IB0996, IC01, IC02, IC03, IC04, IC05, ID01, ID02, ID03, ID04, IE01, IE02, IE03, IE04, IE08, IE09, IF01, IF02, IF03, IF04, IG01, IG02, IG03Title, IG0301, IG0302, IG0303, IG0304, IG0305, IG0306, IG0307, IG0308, IG0309, IG03010, entrydate, username) values('" +
                   form_id + "', '" + IA01.Text + "', '" + IA02.Text + "', '" + IA03.Text + "', '" + IA04.Text + "', '" + IA05.Text + "', '" + IB01.Text + "', '" + IB02.Text + "', '" + IB03.Text + "', '" + dt_IB04.ToShortDateString() + "', '" + IB05.Text + "', '" + IB06.Text + "', '" + IB07.Text + "', '" + IB08.Text + "', '" + IB0901.Text + "', '" + IB0902.Text + "', '" + IB0903.Text + "', '" + IB0996.Text + "', '" + IC01.Text + "', '" + IC02.Text + "', '" + IC03.Text + "', '" + IC04.Text + "', '" + IC05.Text + "', '" + ID01.Text + "', '" + ID02.Text + "', '" + ID03.Text + "', '" + ID04.Text + "', '" + IE01.Text + "', '" + IE02.Text + "', '" + IE03.Text + "', '" + IE04.Text + "', '" + IE08.Text + "', '" + IE09.Text + "', '" + IF01.Text + "', '" + IF02.Text + "', '" + IF03.Text + "', '" + IF04.Text + "', '" + IG01.Text + "', '" + IG02.Text + "', '" + IG03Title.Text + "', '" + IG0301.Text + "', '" + IG0302.Text + "', '" + IG0303.Text + "', '" + IG0304.Text + "', '" + IG0305.Text + "', '" + IG0306.Text + "', '" + IG0307.Text + "', '" + IG0308.Text + "', '" + IG0309.Text + "', '" + IG03010.Text + "', '" + EntryDate.ToShortDateString() + "', '" + CVariables.UserName + "')";
